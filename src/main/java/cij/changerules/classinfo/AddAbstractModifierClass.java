...
public class AddAbstractModifierClass extends ChangeRule {

	private JavaParseTree treeBeforeChange;
	private JavaParseTree treeAfterChange;
	
	public AddAbstractModifierClass(JavaParseTree treeBeforeChange, JavaParseTree treeAfterChange) {
	...
	public ChangeCategory getCategory() {
		if(isChangeCategory(treeBeforeChange, treeAfterChange)) {
			return ChangeCategory.AAbC_ADD_ABSTRACT_MODIFIER_CLASS;
		}
		return null;
	}
