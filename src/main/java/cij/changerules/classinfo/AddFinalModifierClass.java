...
public class AddFinalModifierClass extends ChangeRule {

	private JavaParseTree treeBeforeChange;
	private JavaParseTree treeAfterChange;
	
	public AddFinalModifierClass(JavaParseTree treeBeforeChange, JavaParseTree treeAfterChange) {
	...
	public ChangeCategory getCategory() {
		if(isChangeCategory(treeBeforeChange, treeAfterChange)) {
			return ChangeCategory.AFC_ADD_FINAL_MODIFIER_CLASS;
		}
		return null;
	}
