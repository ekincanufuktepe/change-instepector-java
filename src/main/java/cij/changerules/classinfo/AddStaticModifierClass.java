...
public class AddStaticModifierClass extends ChangeRule {

	private JavaParseTree treeBeforeChange;
	private JavaParseTree treeAfterChange;
	
	public AddStaticModifierClass(JavaParseTree treeBeforeChange, JavaParseTree treeAfterChange) {
	...
	public ChangeCategory getCategory() {
		if(isChangeCategory(treeBeforeChange, treeAfterChange)) {
			return ChangeCategory.ASC_ADD_STATIC_MODIFIER_CLASS;
		}
		return null;
	}
