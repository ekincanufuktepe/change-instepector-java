...
public class AddFinalModifierField  extends ChangeRule {

	private JavaParseTree treeBeforeChange;
	private JavaParseTree treeAfterChange;
	
	public AddFinalModifierField(JavaParseTree treeBeforeChange, JavaParseTree treeAfterChange) {
	...
	public ChangeCategory getCategory() {
		if(isChangeCategory(treeBeforeChange, treeAfterChange)) {
			return ChangeCategory.AFF_ADD_FINAL_MODIFIER_FIELD;
		}
		return null;
	}
