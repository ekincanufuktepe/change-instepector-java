...
public class AddStaticModifierMethod  implements ChangeRule {
	
	private JavaParseTree treeBeforeChange;
	private JavaParseTree treeAfterChange;
	
	public AddStaticModifierMethod(JavaParseTree treeBeforeChange, JavaParseTree treeAfterChange) {
	...
	public ChangeCategory getCategory() {
		if(isChangeCategory(treeBeforeChange, treeAfterChange)) {
			return ChangeCategory.ASM_ADD_STATIC_MODIFIER_METHOD;
		}
		return null;
	}
